...
<body style="margin: 20px; font-family: Arial, sans-serif;">
    ...
    <!-- TABS -->
    <div class="tabs">
        <a class="tab active" href="#">VIDEO EDITION</a>
        <a class="tab" href="#">VIDEO LIST</a>
    </div>
        ...
        <form action="${pageContext.request.contextPath}/admin/video/${isEdit ? 'update' : 'create'}" method="post">
            <div style="display: flex; gap: 20px;">
                ...
                <div style="flex: 3; text-align: center;">
                    ...
                    <input type="text" name="poster" value="${video.poster}" class="form-control" placeholder="Đường dẫn ảnh Poster..." oninput="document.getElementById('posterImg').src=this.value; document.getElementById('posterImg').style.display='block'; document.getElementById('posterText').style.display='none';">
                </div>
            ...
            <div style="text-align: right; border-top: 1px solid #ff9800; padding-top: 15px;">
                ...
                <a href="${pageContext.request.contextPath}/admin/video/delete?id=${video.id}" class="btn btn-delete" onclick="return confirm('Bạn có chắc muốn xóa?');" style="text-decoration:none; display:inline-block; ${!isEdit ? 'pointer-events:none; opacity:0.5;' : ''}">Delete</a>
                <a href="${pageContext.request.contextPath}/admin/video/reset" class="btn btn-reset" style="text-decoration:none; display:inline-block;">Reset</a>
            </div>
        </form>
    </div>
